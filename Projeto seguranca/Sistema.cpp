...
#include<locale.h>
#include<windows.h>
char conteudo[100],conteudo2[100],conteudo3[100],senha[100];
void Menu()
{
	setlocale(LC_ALL,"portuguese");
	FILE *file;
	char senha2[100],senha3[100];
    ...
    switch(opcao)
    {
		...
		fflush(stdin);//Provavelmente o erro esta no fflush que esta detectando o caracter 'p' n sei pq//
       	gets(senha);
			switch(senha[0])
    {
    case'a':
